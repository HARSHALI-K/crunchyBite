        ...
        >
          <Grid container spacing={2}>
            <Grid
              ...
              xs={12}
              sm={6}
              sx={{ position: "absolute", bottom: "260px", left: "120px" }}
            >
              ...
              <Box sx={{ position: "absolute", right: "-28px", bottom: "-91px" }}>
                <motion.img style={{ width: "90%" }} src="/images/chaddar-content.png" alt="" initial={{ opacity: 0, y: 500 }} 
                animate={{ opacity: 1, y: 0 }} 
                transition={{ duration: 0.6, ease: "easeOut" }}/>
              </Box>
              <Box sx={{ position: "absolute", right: "104px", bottom: "-250px" }}>
                <motion.img style={{ width: "80%" }} src="/images/chiddar7.png" alt="" 
                 animate={{
                  y: [-10, 0, -10],
              ...
              <Box sx={{ position: "absolute", left: "-227px", bottom: "-116px" }}>
                <motion.img style={{ width: "80%" }} src="/images/chiddar9.png" alt="" 
                 animate={{
                  y: [-10, 0, -10],
                  transition: { duration: 2.1, repeat: Infinity },
                }}/>
              ...
              <Box sx={{ position: "absolute", left: "-55px", bottom: "-170px" }}>
                <motion.img style={{ width: "80%" }} src="/images/chiddar8.png" alt="" 
                 animate={{
                  y: [-10, 0, -10],
                  transition: { duration: 2.1, repeat: Infinity },
                }}/>
            ...
            >
             ...
             <Box
                ...
                <motion.img style={{ width: "100%" }} src="/images/chiddar.png" alt=""  animate={{
                    y: [-10, 0, -10],
                    transition: { duration: 2.1, repeat: Infinity },
                  }} />
              </Box>
              ...
              <Box sx={{ position: "absolute", right: "-210px", bottom: "-60px" }}>
                <motion.img style={{ width: "100%" }} src="/images/chiddar3.png" alt=""  animate={{
                    y: [-10, 0, -10],
                    transition: { duration: 2.1, repeat: Infinity },
                  }}/>
              </Box>
