          ...
          <Grid container spacing={2}>
            ...
            >
              ...
              <Box sx={{ position: "absolute", right: "72px", bottom: "-91px" }}>
                <motion.img style={{ width: "90%" }} src="/images/lemon-content.png" alt=""
                initial={{ opacity: 0, y: 500 }} 
                animate={{ opacity: 1, y: 0 }} 
                transition={{ duration: 0.6, ease: "easeOut" }} />
              </Box>
            ...
            >
             ...
             <Box sx={{position:'relative'}}>
              ...
              <Box sx={{ position: "absolute", right: "-109px", bottom: "-77px" }}>
                <motion.img style={{ width: "70%" }} src="/images/lemon1.png" alt=""  animate={{
                    y: [-10, 0, -10],
                    transition: { duration: 2.1, repeat: Infinity },
                  }} />
              </Box>
              ...
              <Box
                sx={{ position: "absolute", left: "-470px", bottom: "-84px" }}>
                <motion.img
                  style={{ width: "100%" }}
              ...
              <Box
                sx={{ position: "absolute", left: "-42px", bottom: "203px" }}>
                <motion.img
                  style={{ width: "100%" }}
